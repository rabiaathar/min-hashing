...
public class MinHashingProcessor{
     ...
     * @param dict_size
     */
    public MinHashingProcessor(final int size, final int dict_size) {
     ...
     * @param dict_size
     */
    public MinHashingProcessor(final double error, final int dict_size) {
     ...
     */
    public MinHashingProcessor(final int size, final int dict_size, final long seed) {
     ...
     * guarantee identical hashes across object instantiations
     */
    public MinHashingProcessor(final double error, final int dict_size, final long seed) {
     ...
     */
    public final int[] minHash(final boolean[] vector) {
